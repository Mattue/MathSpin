...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "words/algebra&logic.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "words/geometry.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "words/math&difur.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "words/mathematics.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "words/mathematics_hard.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "words/mathenatics_extream.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "words/metOp&diskr.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "words/programing&computers.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "words/school_math.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "words/sweet_imit.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
