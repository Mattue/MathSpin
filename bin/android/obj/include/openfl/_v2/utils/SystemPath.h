...
#define INCLUDED_openfl__v2_utils_SystemPath

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS3(openfl,_v2,utils,SystemPath)
namespace openfl{
namespace _v2{
namespace utils{
...
class HXCPP_CLASS_ATTRIBUTES  SystemPath_obj : public hx::Object{
	...
	public:
		...
		static ::String lime_filesystem_get_special_dir( int inWhich);
...
#endif /* INCLUDED_openfl__v2_utils_SystemPath */ 
