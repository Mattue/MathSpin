...
::openfl::_v2::utils::SystemPath_obj::__register();
...
::Date_obj::__register();
::Category_Button_obj::__register();
::CategoryOne_obj::__register();
::CategoryChoose_obj::__register();
...
::CategoryChoose_obj::__boot();
::CategoryOne_obj::__boot();
::Category_Button_obj::__boot();
::Date_obj::__boot();
...
::openfl::_v2::utils::SystemPath_obj::__boot();
