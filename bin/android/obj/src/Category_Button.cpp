...
HX_STACK_THIS(this)
{
	...
	this->cat_text = _g3;
	HX_STACK_LINE(31)
	::openfl::_v2::text::TextFormat _g4 = ::openfl::_v2::text::TextFormat_obj::__new(HX_CSTRING("Arial"),(int)30,(int)0,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(31)
	this->cat_textf = _g4;
	HX_STACK_LINE(32)
