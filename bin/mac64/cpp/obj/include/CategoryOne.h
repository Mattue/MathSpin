...
class HXCPP_CLASS_ATTRIBUTES  CategoryOne_obj : public ::openfl::_v2::display::Sprite_obj{
	...
	public:
		...
		::openfl::_v2::display::Sprite right;
		::openfl::_v2::display::Sprite wrong;
		::String documentDer;
		...
		virtual Void onRight( ::openfl::_v2::events::MouseEvent e);
		Dynamic onRight_dyn();

		virtual Void onWrong( ::openfl::_v2::events::MouseEvent e);
		Dynamic onWrong_dyn();
